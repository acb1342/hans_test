		...
		<form method="get" id="vForm" name="vForm" class="form-horizontal form-label-left">
			...
			<div class="form-group">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<input type="text" name="fstRgUsid" readonly="readonly" class="form-control col-md-7 col-xs-12" value="${userId}">
             	</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<input type="text" class="form-control col-md-7 col-xs-12" name="body">
             	</div>
			</div>
