...
<div class="x_content">
    <table class="table table-striped responsive-utilities jambo_table dataTable" aria-describedby="example_info">
        ...
        <tr>
            <td> URL </td>
            <td>
                <input type="text" id="url" style="width: 50%" value="<#if cmsMenuFunc.url?exists>${cmsMenuFunc.url}</#if>">
            </td>
        </tr>
        <tr>
            <td> DESCRIPTION </td>
            <td>
                <textarea style="width:300px;" rows="4" cols="10" id="desc"><#if cmsMenuFunc.description?exists>${cmsMenuFunc.description}</#if></textarea>
            </td>
        </tr>
