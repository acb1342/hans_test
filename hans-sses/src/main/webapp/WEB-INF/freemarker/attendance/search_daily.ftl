...
<body>
	...
	<div class="x_content">
		<form id="vForm" name="vForm" onsubmit="return false">		 
			...
			<div style="margin:1% 0 1.5% 0;" class="col-sm-2">
			...
			<div style="margin:1% 0 1.5% 0; width:1%; line-height:40px; text-align:center;" class="col-sm-1">~</div>
			<div style="margin:1% 0 1.5% 0;" class="col-sm-2">
				<input class="selDate form-control" type="text" id="afterDay" name="afterDay" value="${afterDay}">
			</div>
			
			<div style="margin:1% 0 1% 0;" class="col-sm-3">
