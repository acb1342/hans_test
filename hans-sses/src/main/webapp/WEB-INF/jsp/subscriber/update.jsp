...
<form method="post" id="vForm" name="vForm" action="/subscriber/update.htm">
<div class="wrap00">
	<!-- input _ start -->
	<table style="width:100%">
		...
		<tr>
			...
			<td colspan="2" class="td02">
				<input type="text" name="id" readOnly="readonly" value="${endUser.id}">
			</td>
		</tr>
		...
		<tr>
			...
			<td colspan="2" class="td02">
				...
				<c:forEach items="${applicationLists}" var="appLists">
					<option value="${appLists.id}" ${endUser.appId == appLists.appId ? "selected='selected'":""}>
						${appLists.appId}
					</option>
				</c:forEach>
				</select>
		...
		<tr>
			...
			<td colspan="2" class="td02">
				<select name="os">
					<c:if test="${endUser.os == 'ios'}">
						<option value="ios" selected>ios</option>
						<option value="android">android</option>
					</c:if>
					<c:if test="${endUser.os == 'android'}">
		...
		<tr>
			...
			<td class="td02">
				<d:countryCombobox name="locale" value="${endUser.locale}"/>
			</td>
		</tr>
		<tr class="line-dot"><td colspan="3"/></tr>
		<!-- Market -->
