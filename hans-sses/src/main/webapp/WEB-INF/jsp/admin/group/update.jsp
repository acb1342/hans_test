...
<spring:hasBindErrors name="adminGroup"/>
<form method="post" id="vForm" name="vForm" action="/admin/group/update.htm">
<div class="wrap00">
	<!-- input _ start -->
	<table style="width:100%">
		...
		<tr>
			<td height="25" class="td01">
				...
				<fmt:message key="label.cmsGroup.id"/><font color="#FF0000">*</font>
			</td>
			<td colspan="2" class="td02">
				<input type="text" name="id" value="${adminGroup.id}" readonly="readonly"/>
			</td>
		</tr>
		...
		<tr>
			...
			<td colspan="2" class="td02">
				<input type="text" name="name" value="${adminGroup.name}">
			</td>
		</tr>
		<tr class="line-dot"><td colspan="3"/></tr>
		<!-- 설명 -->
		<tr>
			...
			<td colspan="2" class="td02">
				<textarea name="description">${adminGroup.description}</textarea>
			</td>
		</tr>
		<tr class="line-dot"><td colspan="3"/></tr>
		<!-- 권한리스트 -->
