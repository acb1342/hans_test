	    ...
	    $("#vForm").validate({
			...
			messages:{
				'id':{
					...
					remote:'<fmt:message key="validate.duplicated.securityKey"/>'
				},
...
<form method="post" id="vForm" name="vForm" action="/admin/securityKey/create.htm">
<div class="wrap00">
	<!-- input _ start -->
	<table style="width:100%">
		...
		<tr>
			...
			<td colspan="2" class="td02">
				<input type="text" name="id" id="id" value="${securityKey.id}" style="width:500px;">
			</td>
		</tr>
