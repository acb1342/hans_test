...
<form method="post" id="vForm" name="vForm" action="/admin/operator/create.htm">
	...
	<table style="width:100%">
		...
		<tr>
			<td height="25" class="td01">
				...
				<fmt:message key="label.cmsUser.landlordId"/><font color="#FF0000">*</font>
			</td>
		...
		<tr>
			<td height="25" class="td01">
				<span class="bul_dot1">◆</span>
				<fmt:message key="label.cmsUser.landlordName"/>
			</td>
			<td colspan="2" class="td02">
		...
		<tr>
			<td height="25" class="td01">
				<span class="bul_dot1">◆</span>
				<fmt:message key="label.push.userPhone"/>
			</td>
			<td colspan="2" class="td02">
