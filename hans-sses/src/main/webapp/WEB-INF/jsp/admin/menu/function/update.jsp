...
<form method="post" id="vForm" name="vForm" action="/admin/menu/function/update.htm">
<input type="hidden" name="menu.id" value="${cmsMenuFunction.menu.id}"/>
<div class="wrap02">
	<!-- input _ start -->
	<table style="width:100%">
		...
		<tr>
			<td height="25" class="td01">
				...
				<fmt:message key="label.cmsMenu.function.id"/><font color="#FF0000">*</font>
			</td>
			<td colspan="2" class="td02">
				<input type="text" name="id" readOnly="readonly" value="${cmsMenuFunction.id}">
			</td>
		</tr>
		...
		<tr>
			...
			<td colspan="2" class="td02">
				...
				<c:forEach items="${types}" var="type">
					<option value="${type}" ${cmsMenuFunction.auth == type ? 'selected':'' }>${type}</option>
				</c:forEach>
				</select>
			</td>
		</tr>
