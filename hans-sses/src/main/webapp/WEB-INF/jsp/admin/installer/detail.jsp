...
<script type="text/javascript">
	...
	// 수정 페이지로 이동
	function update() {
		window.location.href = "/admin/installer/update.htm?id=${admin.id}";
	}

	// 삭제
	function confirmAndDelete() {
		deleteById('/admin/installer/delete.json', '${admin.id}', function() { 
			search();
		});
	}
	...
	function search() {
		...
		if (callbackUrl != 'null') {
			location.href = "/admin/installer/search.htm?" + callbackUrl;
		} else {
			location.href = "/admin/installer/search.htm";
		}
	}
	
	// 생성 페이지로 이동
	function createMember() {
		document.location = "/admin/installer/member/create.htm?defaultUserId=${admin.id}";
	}
</script>
<div class="wrap00">
	<!-- list _ start -->
	<table style="width:100%">
		...
		<tr>
			<td height="25" class="td01">
				...
				<fmt:message key="label.cmsUser.installerId"/>
			</td>
		...
		<tr>
			<td height="25" class="td01">
				<span class="bul_dot1">◆</span>
				<fmt:message key="label.cmsUser.installerPhone"/>
			</td>
