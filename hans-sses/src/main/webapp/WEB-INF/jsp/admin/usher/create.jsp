...
<script type="text/javascript">
	$(function() {
		...
		$('#save').click(function(e) {
			var strSpace = $('#regId').val();
			// ID 중복체크
			if ($('#isIdCheckComplete').val() == '' || strSpace.replace(/s/gi,'') == '') {
				alert("ID 중복확인을 해주세요.");
				$('#regId').focus();
				return;
			}
		...
		$('#cancel').click(function(e) {
			window.location.href = "/admin/usher/search.htm";
		});
...
<form method="post" id="vForm" name="vForm" action="/admin/usher/create.htm">
