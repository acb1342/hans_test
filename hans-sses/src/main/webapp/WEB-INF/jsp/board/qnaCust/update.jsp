...
<script type="text/javascript">
	$(function() {
		...
		$('#questionUpdate').click(function(e) {
			...
			location.href="/board/qnaCust/execUpdateQuestion.htm?id=${boadQna.snId}&page=${page}&target=question"+appendUrl;
		});
	...
	function cancel() {
		if(confirm("정말 취소하시겠습니까?")) window.location.href = "/board/qnaCust/search.htm";
	}

</script>

<spring:hasBindErrors name="board"/>
<form method="post" id="vForm" name="vForm" action="/board/qnaCust/update.htm?id=${boadQna.snId}&page=${page}">
