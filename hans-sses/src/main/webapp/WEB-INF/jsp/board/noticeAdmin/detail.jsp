...
<script type="text/javascript">
	// 수정 페이지로 이동
	function update() {
		location.href = "/board/noticeAdmin/update.htm?id=${boadNotice.snId}";
	}

	// 삭제
	function confirmAndDelete() {
		deleteById('/board/noticeAdmin/delete.json', '${boadNotice.snId}', function() { 
			search();
		});
	}
	...
	function search() {
		...
		if (callbackUrl != 'null') {
			location.href = "/board/noticeAdmin/search.htm?" + callbackUrl;
		} else {
			location.href = "/board/noticeAdmin/search.htm";
		}
	}
</script>
<div class="wrap00">
