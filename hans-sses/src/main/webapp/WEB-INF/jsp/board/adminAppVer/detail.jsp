...
//수정 페이지로 이동
function update() {
	location.href = "/board/adminAppVer/update.htm?seq=${appVer.snId}";
}
...
function search() {
	...
	if (callbackUrl != 'null') {
		location.href = "/board/adminAppVer/search.htm?" + callbackUrl;
	} else {
		location.href = "/board/adminAppVer/search.htm";
	}
}
</script>
...
<div class="wrap00">
	...
	<table style="width:100%">
		...
		<tr>
			...
			<td colspan="5" class="td02"><fmt:message key="${appVer.targetType}"/></td>
		</tr>
