...
--%>
	// 수정
	function update() {
		document.location = "/editor/simpleUpdate.htm?id=${contentEditor.id}";
	}

	// <fmt:message key="label.contentEditor.remove"/>
	...
	function search() {
		...
		if (callbackUrl != 'null') {
			document.location = "/editor/simpleSearch.htm?" + callbackUrl;
		} else {
