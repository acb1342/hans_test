...
<script type="text/javascript">
	$(function() {
		...
		CKEDITOR.on( 'dialogDefinition', function( ev ) {
		    ...
		    // 20150605 "cke_iframe" is a class for image elements with red "Iframe" title, "cke-realelement" is a data parameter with uri encoded html description of a real iframe element.
...
<body class="edit">
<form method="post" id="vForm" name="vForm" action="/editor/update.htm">
...
<div class="wrap00">
	<div class="section2">
		<div class="btn-group" data-toggle="buttons-radio">
			<button type="button" class="btn active" id="edit-mode"><i class="icon-edit icon-white"></i> <fmt:message key="label.common.editMode"/></button>
			<button type="button" class="btn" id="drag-mode"><i class="icon-move icon-white"></i> <fmt:message key="label.common.dragMode"/></button>
		</div>
