...
<form method="post" id="vForm" name="vForm" action="/sender/info/create.htm">
<div class="wrap00">
	<!-- input _ start -->
	<table style="width:100%">
		...
		<tr>
			...
			<td colspan="6" class="td02">
				<input type="text" id="id" name="id" value="${senderInfo.id}" maxlength="32">
			</td>
		</tr>
		...
		<tr>
			...
			<td colspan="3" class="td02">
				<input type="text" id="senderName" name="senderName" value="${senderInfo.senderName}" maxlength="32">
			</td>
			<td height="25" class="td01">
				<span class="bul_dot1">◆</span>
		...
		<tr>
			...
			<td width="290px" class="td02">
				<input type="text" id="senderId" name="senderId" value="${senderInfo.senderId}" maxlength="32">
			</td>
		</tr>
		<tr class="line-dot"><td colspan="6"/></tr>
		<!-- APP ID -->
