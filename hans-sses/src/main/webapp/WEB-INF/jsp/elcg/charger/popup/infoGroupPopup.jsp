...
<form method="post" id="vForm" name="vForm" action="/elcg/charger/popup/infoGroupPopup.htm">

	<div class="wrap_winpop">
		<div class="header_area">
			<h3 class="tit">충전그룹정보</h3>
		</div>
		...
		<tr>
			...
			<td colspan="2" class="td02">${group.name}</td>
		</tr>
		...
		<tr>
			...
			<td colspan="2" class="td02">${group.capacity}</td>
		</tr>
		<tr class="line-dot"><td colspan="2"/></tr>
		<tr>
			<td height="25" class="td01">
			...
			<td colspan="2" class="td02">${group.chargerSize}</td>
		</tr>
		<tr class="line-dot"><td colspan="2"/></tr>
