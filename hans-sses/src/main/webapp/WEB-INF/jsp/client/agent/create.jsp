...
<form method="post" id="vForm" name="vForm" action="/client/agent/create.htm">
<div class="wrap00">
	<!-- input _ start -->
	<table style="width:100%">
		...
		<tr>
			...
			<td colspan="2" class="td02">
				<select id="contentProviderId" name="contentProviderId">
				<option value=""><fmt:message key="label.common.option"/></option>
				<c:forEach items="${contentProviderList}" var="contentProvider">
					<option value="${contentProvider.id}">${contentProvider.cpName}</option>
				</c:forEach>
				</select>
			</td>
		</tr>
