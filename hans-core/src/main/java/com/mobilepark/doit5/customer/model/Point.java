 ...
 */
@Entity
@Table(name = "TB_CUST_POINT")
public class Point extends AbstractModel<Long> implements Serializable {

	private static final long serialVersionUID = -5017598214874875178L;
