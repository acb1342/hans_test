 ...
 */
@Entity
@Table(name = "TB_STAT_CHARGE_MONTH")
public class ChargeMonth extends AbstractModel<Long> implements Serializable {

	private static final long serialVersionUID = -5278643212033496055L;
