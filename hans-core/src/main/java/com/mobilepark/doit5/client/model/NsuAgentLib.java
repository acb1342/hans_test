 ...
 */
@Entity
@Table(name = "TBL_NSU_AGENT_LIB", catalog = "upush")
public class NsuAgentLib extends AbstractModel<Integer> {
	@Id
	...
	@Column(name = "APPLY_START_YMD", length = 19)
