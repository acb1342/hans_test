...
public class BoadNoticeCust extends AbstractModel<Long> implements Serializable{
	
	private static final long serialVersionUID = -6341261367446533093L;
