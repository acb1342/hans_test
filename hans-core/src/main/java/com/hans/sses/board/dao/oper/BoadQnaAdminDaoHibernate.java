 ...
 * @Filename     : BoadQnaAdminDaoHibernate.java
 * 
...
public class BoadQnaAdminDaoHibernate extends HibernateGenericDao<BoadQnaAdmin, Long>
		implements BoadQnaAdminDao {

	@Override
	protected Criteria getCriteria(BoadQnaAdmin entity) {
		Criteria criteria = getCurrentSession().createCriteria(BoadQnaAdmin.class);
		if (entity != null) {
